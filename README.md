...
2. **Запуск HDFS:**
   ...
   sbin/start-dfs.sh
   ```
   ![image](https://github.com/user-attachments/assets/f2c6f096-0646-4d47-8d9d-cc3c36852b4c)
...
3. **Проверка состояния процессов:**
   ...
   jps
   ```
   ![image](https://github.com/user-attachments/assets/f483bdf0-fd94-42e3-87c4-916b752e1dcf)
...
![image](https://github.com/user-attachments/assets/c6855597-9fa1-4452-9c46-5d6fb5f4f8fd)


![image](https://github.com/user-attachments/assets/4fd51a0e-70ef-4f6a-a7da-9a0d8de1768f)
